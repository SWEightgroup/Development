...
export const _label = {
  it: {
    ...
    dashboard_progress: 'I tuoi progressi',
    dashboard_progress_2: 'Il tuo livello attuale e il prossimo obiettivo',
  ...
  en: {
    ...
    dashboard_progress_2: 'Your current level and your next goal',
