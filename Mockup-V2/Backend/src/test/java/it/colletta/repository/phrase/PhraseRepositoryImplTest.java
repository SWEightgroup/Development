...
public class PhraseRepositoryImplTest {
  ...
  private void populateDatabase() {
    ...
    oneSolutionList.add(
        SolutionModel.builder().id("11").solutionText("first solution").authorId("1")
            .dateSolution(1000L).reliability(1).build());

    ArrayList<SolutionModel> multipleSolutionsList = new ArrayList<>();
    multipleSolutionsList.add(
        SolutionModel.builder().id("12").solutionText("second solution").dateSolution(2000L)
            .authorId("1").reliability(5).build());

    multipleSolutionsList.add(
        SolutionModel.builder().id("13").solutionText("third solution").dateSolution(3000L)
            .authorId("2").reliability(2).build());

    multipleSolutionsList.add(
        SolutionModel.builder().id("14").solutionText("fourth solution").dateSolution(4000L)
            .authorId("1").reliability(6).build());

    noSolutionPhrase = PhraseModel.builder().id("1").phraseText("no solution phrase").language("en")
        .build();

    oneSolutionPhrase =
        PhraseModel.builder().id("2").phraseText("one solution phrase").language("es")
    ...
    SolutionModel testSolution = SolutionModel.builder().solutionText("test solution")
        .dateSolution(2500L).authorId("5").reliability(6).build();
    testPhrase = PhraseModel.builder().phraseText("test phrase")
        .solutions(new ArrayList<>(Arrays.asList(testSolution))).build();
